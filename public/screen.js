...
navigator.mediaDevices.getDisplayMedia(displayMediaOption)
.then(stream=>{
...
$('.main__video__button').click(()=>{
      ...
      if (enabled) {
        myVideoStream.getVideoTracks()[0] = "jkjdjwejiwcjjwepjpec";
        setPlayVideo();
...
//         addVideoStream(videoScreen,stream)
        // socket.on('join-room', (ROOM_ID,userId,USERS,Data.host) 
